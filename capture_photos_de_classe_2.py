...
cap=cv2.VideoCapture('data/fichier_video/presence_2_bon_video_2.3minute.mp4')
...
while True:
    ...
    for x, y, w, h in face:
        cv2.imwrite('data/fichier_image/photo_classe_2/p-{:d}.png'.format(id), frame[y:y+h, x:x+w])
